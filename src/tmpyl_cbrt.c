...
/*  Python wrapper for the cbrt function from libtmpl.                        */
PyObject *tmpyl_cbrt(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Cbrt;
    c_funcs.double_func = tmpl_Double_Cbrt;
    c_funcs.ldouble_func = tmpl_LDouble_Cbrt;
