...
/*  Python wrapper for the cosd function from libtmpl.                        */
PyObject *tmpyl_cosd(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Cosd;
    c_funcs.d2d = tmpl_Double_Cosd;
    c_funcs.ld2ld = tmpl_LDouble_Cosd;
