...
PyObject *tmpyl_asin_pade(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Arcsin_Pade;
    c_funcs.double_func = tmpl_Double_Arcsin_Pade;
    c_funcs.ldouble_func = tmpl_LDouble_Arcsin_Pade;
    ...
    c_funcs.func_name = "asin_pade";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_asin_pade.                                                   */
