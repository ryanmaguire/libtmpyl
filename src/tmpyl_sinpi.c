...
/*  Python wrapper for the sinpi function from libtmpl.                       */
PyObject *tmpyl_sinpi(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_SinPi;
    c_funcs.d2d = tmpl_Double_SinPi;
    c_funcs.ld2ld = tmpl_LDouble_SinPi;
