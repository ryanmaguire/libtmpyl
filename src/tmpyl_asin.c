...
PyObject *tmpyl_asin(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Arcsin;
    c_funcs.double_func = tmpl_Double_Arcsin;
    c_funcs.ldouble_func = tmpl_LDouble_Arcsin;
