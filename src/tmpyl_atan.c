...
/*  Python wrapper for the arctan function from libtmpl.                      */
PyObject *tmpyl_atan(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Arctan;
    c_funcs.double_func = tmpl_Double_Arctan;
    c_funcs.ldouble_func = tmpl_LDouble_Arctan;
