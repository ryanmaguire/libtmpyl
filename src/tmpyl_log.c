...
/*  Python wrapper for the log function from libtmpl.                         */
PyObject *tmpyl_log(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Log;
    c_funcs.double_func = tmpl_Double_Log;
    c_funcs.ldouble_func = tmpl_LDouble_Log;
