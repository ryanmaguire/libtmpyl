...
/*  Python wrapper for the cospi function from libtmpl.                       */
PyObject *tmpyl_cospi(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_CosPi;
    c_funcs.d2d = tmpl_Double_CosPi;
    c_funcs.ld2ld = tmpl_LDouble_CosPi;
