...
PyObject *tmpyl_acos(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Arccos;
    c_funcs.double_func = tmpl_Double_Arccos;
    c_funcs.ldouble_func = tmpl_LDouble_Arccos;
