...
/*  Python wrapper for the fractional_part function from libtmpl.             */
PyObject *tmpyl_fractional_part(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Fractional_Part;
    c_funcs.d2d = tmpl_Double_Fractional_Part;
    c_funcs.ld2ld = tmpl_LDouble_Fractional_Part;
    ...
    c_funcs.func_name = "fractional_part";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_fractional_part.                                             */
