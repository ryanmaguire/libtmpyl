...
{                                                                              \
    ...
    "tmpyl.cosd\n\r\t"                                                         \
    "Purpose:\n\r\t\t"                                                         \
    "Compute the cosine of the input in degrees."                              \
    "\n\r\tArguments\n\r\t\t"                                                  \
    "x:\n\r\t\t\t"                                                             \
    "Independent variable for cosd(x). Allowed inputs are int,\n\r\t\t\t"      \
    "float, complex, list (of ints, floats, and complex),\n\r\t\t\t"           \
    "and numpy arrays (if tmpyl was built with numpy support).\n\r\t"          \
    "Outputs:\n\r\t\t"                                                         \
    "cosd_x:\n\r\t\t\t"                                                        \
    "Cosine as a function of x in degrees. Same type as input.\n\r\t"          \
    "Example:\n\r\t\t"                                                         \
    ">>> import numpy\n\r\t\t"                                                 \
    ">>> import tmpyl\n\r\t\t"                                                 \
