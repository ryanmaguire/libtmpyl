...
/*  Python wrapper for the Bessel J1 function from libtmpl.                   */
PyObject *tmpyl_bessel_j1(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = NULL;
    c_funcs.d2d = tmpl_Double_Bessel_J1;
    c_funcs.ld2ld = NULL;
    ...
    c_funcs.func_name = "bessel_j1";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_bessel_j1.                                                   */
