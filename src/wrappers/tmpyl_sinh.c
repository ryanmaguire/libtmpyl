...
/*  Python wrapper for the sinh function from libtmpl.                        */
PyObject *tmpyl_sinh(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Sinh;
    c_funcs.d2d = tmpl_Double_Sinh;
    c_funcs.ld2ld = tmpl_LDouble_Sinh;
