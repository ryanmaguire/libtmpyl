...
/*  Python wrapper for the Airy J1 function from libtmpl.                     */
PyObject *tmpyl_airy_j1(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = NULL;
    c_funcs.d2d = tmpl_Double_Airy_J1;
    c_funcs.ld2ld = NULL;
