...
/*  Python wrapper for the cosh function from libtmpl.                        */
PyObject *tmpyl_cosh(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Cosh;
    c_funcs.d2d = tmpl_Double_Cosh;
    c_funcs.ld2ld = tmpl_LDouble_Cosh;
