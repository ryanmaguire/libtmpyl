...
/*  Python wrapper for the error function from libtmpl.                       */
PyObject *tmpyl_erf(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Erf;
    c_funcs.d2d = tmpl_Double_Erf;
    c_funcs.ld2ld = tmpl_LDouble_Erf;
