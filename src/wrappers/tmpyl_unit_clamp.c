...
/*  Python wrapper for the unit_clamp function from libtmpl.                  */
PyObject *tmpyl_unit_clamp(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Unit_Clamp;
    c_funcs.d2d = tmpl_Double_Unit_Clamp;
    c_funcs.ld2ld = tmpl_LDouble_Unit_Clamp;
    ...
    c_funcs.func_name = "unit_clamp";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_unit_clamp.                                                  */
