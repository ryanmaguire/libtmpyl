...
/*  Python wrapper for the trunc function from libtmpl.                       */
PyObject *tmpyl_trunc(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Truncate;
    c_funcs.d2d = tmpl_Double_Truncate;
    c_funcs.ld2ld = tmpl_LDouble_Truncate;
