...
/*  Python wrapper for the tan function from libtmpl.                         */
PyObject *tmpyl_tan(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Tan;
    c_funcs.d2d = tmpl_Double_Tan;
    c_funcs.ld2ld = tmpl_LDouble_Tan;
