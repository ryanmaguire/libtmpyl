...
/*  Python wrapper for the sin function from libtmpl.                         */
PyObject *tmpyl_sin(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Sin;
    c_funcs.d2d = tmpl_Double_Sin;
    c_funcs.ld2ld = tmpl_LDouble_Sin;
