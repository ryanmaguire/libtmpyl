...
/*  Python wrapper for the exp function from libtmpl.                         */
PyObject *tmpyl_exp(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Exp;
    c_funcs.double_func = tmpl_Double_Exp;
    c_funcs.ldouble_func = tmpl_LDouble_Exp;
