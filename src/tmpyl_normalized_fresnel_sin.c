...
PyObject *tmpyl_normalized_fresnel_sin(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_Normalized_Fresnel_Sin;
    c_funcs.d2d = tmpl_Double_Normalized_Fresnel_Sin;
    c_funcs.ld2ld = tmpl_LDouble_Normalized_Fresnel_Sin;
    ...
    c_funcs.func_name = "normalized_fresnel_sin";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_normalized_fresnel_sin.                                      */
