...
/*  Python wrapper for the mod_360 function from libtmpl.                     */
PyObject *tmpyl_mod_360(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Mod_360;
    c_funcs.double_func = tmpl_Double_Mod_360;
    c_funcs.ldouble_func = tmpl_LDouble_Mod_360;
