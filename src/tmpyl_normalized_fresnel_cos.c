...
PyObject *tmpyl_normalized_fresnel_cos(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Normalized_Fresnel_Cos;
    c_funcs.double_func = tmpl_Double_Normalized_Fresnel_Cos;
    c_funcs.ldouble_func = tmpl_LDouble_Normalized_Fresnel_Cos;
    ...
    c_funcs.func_name = "normalized_fresnel_cos";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_normalized_fresnel_cos.                                      */
