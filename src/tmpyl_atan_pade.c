...
/*  Python wrapper for the atan_pade function from libtmpl.                   */
PyObject *tmpyl_atan_pade(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Arctan_Pade;
    c_funcs.double_func = tmpl_Double_Arctan_Pade;
    c_funcs.ldouble_func = tmpl_LDouble_Arctan_Pade;
    ...
    c_funcs.func_name = "atan_pade";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_atan_pade.                                                   */
