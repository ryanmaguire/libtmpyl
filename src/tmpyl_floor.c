...
/*  Python wrapper for the floor function from libtmpl.                       */
PyObject *tmpyl_floor(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Floor;
    c_funcs.double_func = tmpl_Double_Floor;
    c_funcs.ldouble_func = tmpl_LDouble_Floor;
