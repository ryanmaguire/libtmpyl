...
PyObject *tmpyl_acos_maclaurin(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Arccos_Maclaurin;
    c_funcs.double_func = tmpl_Double_Arccos_Maclaurin;
    c_funcs.ldouble_func = tmpl_LDouble_Arccos_Maclaurin;
    ...
    c_funcs.func_name = "acos_maclaurin";

    return tmpl_Get_Py_Func_From_C(self, args, &c_funcs);
}
/*  End of tmpyl_acos_maclaurin.                                              */
