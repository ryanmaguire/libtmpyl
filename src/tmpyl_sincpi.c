...
/*  Python wrapper for the sincpi function from libtmpl.                      */
PyObject *tmpyl_sincpi(PyObject *self, PyObject *args)
{
    ...
    c_funcs.f2f = tmpl_Float_SincPi;
    c_funcs.d2d = tmpl_Double_SincPi;
    c_funcs.ld2ld = tmpl_LDouble_SincPi;
