...
/*  Python wrapper for the sind function from libtmpl.                        */
PyObject *tmpyl_sind(PyObject *self, PyObject *args)
{
    ...
    c_funcs.float_func = tmpl_Float_Sind;
    c_funcs.double_func = tmpl_Double_Sind;
    c_funcs.ldouble_func = tmpl_LDouble_Sind;
